const apiKey = '8603c4850f36917a0565bddde8199bfb'; // Substitua pela sua chave válida
...
async function buscarLigas() {
    try {
        ...
        console.log('Ligas encontradas:', data); // Verificando os dados retornados
...
async function buscarJogos(ligaId) {
    try {
        ...
        const data = await response.json();
        console.log('Jogos da Liga:', data); // Verificando os dados retornados
