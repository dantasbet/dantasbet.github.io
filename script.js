...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Carregar ligas automaticamente ao entrar no site (data atual)
    const hoje = new Date().toISOString().split('T')[0]; // Data no formato YYYY-MM-DD
    buscarLigas(hoje);

    // Buscar ligas com jogos disponíveis na data atual
    ...
    // Calcular as médias dos últimos 5 jogos
    ...
    // Buscar últimos 5 jogos de um time
